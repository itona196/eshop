    ...
    return (
        <div className="bg-gradient-to-br from-purple-100 via-blue-100 to-pink-100 min-h-screen py-12 px-5 md:px-20">
            <div className="max-w-4xl mx-auto bg-secondary p-8 shadow-lg rounded-xl">
                ...
                <p className="text-text text-center mt-6">Si vous avez des questions, contactez-nous à <a href="mailto:support@loop.com" className="text-accent font-bold">support@loop.com</a>.</p>
            </div>
        </div>
    );
}
